...
class ReportsMenu extends StatefulWidget {
  ...
  const ReportsMenu({Key? key, required this.onBack}) : super(key: key);
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      const Padding(padding: EdgeInsets.symmetric(horizontal: 8), child: Text('الي')),
                      SizedBox(
                        width: 120,
                        child: TextField(
                  ...
                  const Text('للفترة من', style: TextStyle(color: AppColors.textSecondary)),
                ],
              ),
            ),
            // Reports List
    ...
    return Column(
      ...
      children: [
        ...
        ...reports.map((report) => Container(
          color: Colors.white,
          child: ListTile(
            title: Text(report, textAlign: TextAlign.right),
